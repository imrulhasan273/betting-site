...
<div class="row">
    ...
    <div class="col-md-12">
      <div class="card">
        ...
        <form method="POST" action="{{route('admin.auto_stack.stack_options.ques.answer.store')}}" enctype="multipart/form-data">
        @csrf
            ...
            <div class="col-md-12" hidden>
                <div class="form-group">
                    ...
                    <input name="question_id" value="{{ $stackQuestion->id }}" type="text" class="form-control">
                </div>
            </div>
