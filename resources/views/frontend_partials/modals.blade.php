    ...
    <!-- ======================= END BETTING ON ANSWERS-===================== -->
      ...
      @include('home.partials_home.partials.UtUbTransfer_modal')
    ...
    <!-- ======================= START DEPOSIT FOR USERS-===================== -->
    @include('home.partials_home.partials.deposit_modal')
    <!-- ======================= END DEPOSIT ON ANSWERS-===================== -->

    <!-- ======================= START WIDTHDRAW ON ANSWERS-===================== -->
    @include('home.partials_home.partials.widthdraw_modal')
    <!-- ======================= END WIDTHDRAW FOR USERS-===================== -->
