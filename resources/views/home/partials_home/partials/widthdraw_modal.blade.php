                ...
                <div class="">
                    <div role="form" class="register-form">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label style="text-align: left;width: 100%;">Method<span style="color:#4267B2;"></span></label>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <label style="text-align: left;width: 100%;">Type<span style="color:#4267B2;"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6"><input type="submit" id="widthdrawSubmit" value="Submit" class="btn  btn-block btn-lg" tabindex="7" style="  background:#4267B2;color: #fff"></div>
                        </div>
                    </div>
                </div>
            </div>
