<div id="tab101" class="tab-pane fade">
    ...
    <div style="margin-top: 111px;">
        ...
        <div class="panel-collapse collapse in" id="BNtab3collapse">

            <!-- START GAME LOOP -->
            @foreach ($games as $game)
            @if ($game->type->name == 'badminton' && $game->status=='live')
            @php
                $quesCount++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#BNtab33419{{$quesCount}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
                ...
                <div id="3419" class="panel-collapse collapse in">
                    <div class="que" style="">
                        <div class="collapse_2nd" style="">
                            ...
                            <div class="qtitle" data-toggle="collapse" data-parent="#accordion" href="#BNq323845{{$ansCount}}" style="">
                            ...
                            <div id="BNq323845{{$ansCount}}" class="panel-collapse">
    ...
    <div>
        @php
            $Collection = App\Game::where([['status','=','upcoming'],['type_id', '=', 6]])->get();
            $UpcomingCount = $Collection->count();
        @endphp
        <div class="live" data-toggle="collapse" href="#BNUtab3collapse" data-parent="#accordion">
        ...
        <div class="panel-collapse collapse in" id="BNUtab3collapse">

            <!-- START GAME LOOP -->
            @foreach ($games as $game)
            @if ($game->type->name == 'badminton' && $game->status=='upcoming')
            @php
                $quesCountU++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#BNUtab33419{{$quesCountU}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
                <span class="gameicon"><img src="{{asset('frontend/img/BN.png')}}" width="27px;"></span>
                <h3 class="panel-title ">
                    {{ $game->name }}, {{ $game->tournament_name }} || {{ $game->date }} || {{ $game->time }}
                </h3>
                ...
                <div id="3419" class="panel-collapse collapse in">
                    <div class="que" style="">
                        <div class="collapse_2nd" style="">
                            ...
                            <div class="qtitle" data-toggle="collapse" data-parent="#accordion" href="#BNUq323845{{$ansCountU}}" style="">
                                <h4 class="panel-title qtitletext">
                                    {{$question->question}}<span style="margin-left: 5px;color:#37b000!important;font-size:.7em;"><i> UPCOMING</i></span>
                                </h4>
                            </div>
                            <div id="BNUq323845{{$ansCountU}}" class="panel-collapse">
                                <div class="container-fluid">
                                    <div class="row" style="background: #5F5F5F">
