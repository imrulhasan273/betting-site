    ...
    <div style="margin-top: 111px;">
        ...
        <div class="panel-collapse collapse in" id="tab3collapse">
            ...
            @php
                $quesCount++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#tab33419{{$quesCount}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
                ...
                <div id="3419" class="panel-collapse collapse in">
                    <div class="que" style="">
                        <div class="collapse_2nd" style="">
                            ...
                            @if ($game->id == $question->game_id)       <!---- BREAK 1---->
                            @php
                                $ansCount++
                            @endphp
                            ...
                            <div id="q323845{{$ansCount}}" class="panel-collapse">
                                <div class="container-fluid">
                                    <div class="row" style="background: #5F5F5F">
                                        ...
                                        @if ($question->id == $answer->question_id && $answer->status == 'active' && $answer->result=='' && $question->is_active==1)            <!-- BREAK 2-->
    ...
    <div>
        ...
        <div class="panel-collapse collapse in" id="Utab3collapse">
            ...
            @php
                $quesCountU++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#Utab33419{{$quesCountU}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
                <span class="gameicon"><img src="{{asset('frontend/img/ka-pl.png')}}" width="27px;"></span>
                <h3 class="panel-title ">
                    {{ $game->name }}, {{ $game->tournament_name }} || {{ $game->date }} || {{ $game->time }}
                </h3>
