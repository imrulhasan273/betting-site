    ...
    <div style="margin-top: 111px;">
        ...
        <div class="panel-collapse collapse in" id="Ttab3collapse">
            ...
            @php
                $quesCount++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#Ttab33419{{$quesCount}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
    ...
    <div>
        ...
        <div class="panel-collapse collapse in" id="TUtab3collapse">
            ...
            @php
                $quesCountU++;
            @endphp
            <div class="" data-toggle="collapse" data-parent="#accordion" href="#TUtab33419{{$quesCountU}}" style="background:#4267B2;padding: 12px 7px;min-height:54px;">
                <span class="gameicon"><img src="{{asset('frontend/img/T.png')}}" width="27px;"></span>
                <h3 class="panel-title ">
                    {{ $game->name }}, {{ $game->tournament_name }} || {{ $game->date }} || {{ $game->time }}
                </h3>
