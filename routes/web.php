...
route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/clubs/userlist', 'ClubController@userlist')->name('clubs.user.list')->middleware(['roleChecker:club_admin,null,null']); #club can't edit club
    ...
    Route::get('/clubs/transection', 'ClubController@ClubTransection')->name('admin.clubs.transection.list')->middleware(['roleChecker:null,null,club_admin']);
    ...
    Route::get('/games/betting_options/ans/add/{game}/{question}', 'AnswerController@add')->name('admin.games.bet.ques.answer.add')->middleware(['roleChecker:super_admin,admin,null']);
